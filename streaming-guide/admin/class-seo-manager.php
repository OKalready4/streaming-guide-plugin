...
class Streaming_Guide_SEO_Manager {
    ...
    public function check_dependencies() {
        ...
        if (!$screen || !in_array($screen->id, array('toplevel_page_streaming-guide', 'streaming-guide_page_streaming-guide-settings'))) {
            return;
        }
        ...
        if (!class_exists('WPSEO_Utils')) {
            $missing_deps[] = 'Yoast SEO';
        }
        if (!class_exists('RankMath')) {
            $missing_deps[] = 'Rank Math';
        }
        ...
        if (!empty($missing_deps)) {
            ...
            <div class="notice notice-warning">
                <p>
                    <strong>Streaming Guide SEO Features:</strong> Some SEO features require additional plugins. 
                    For full functionality, please install and activate:
